window.GC_GLOSSARY = {
  ...
  // --- Stoichiometry & BCA Tables (2-7c) ---

  'stoichiometry': {
    term: 'Stoichiometry',
    definition: 'The math of chemical reactions. It lets you use a balanced chemical equation to predict exactly how much reactant you need or how much product you will make. It relies on the mole ratio to convert between the quantities of different substances involved in the reaction.',
  },

  'limiting-reactant': {
    term: 'Limiting Reactant',
    definition: 'The reactant that runs out first in a chemical reaction. It sets the ceiling on how much product can form — once it is gone, the reaction stops. It is not necessarily the reactant you have the fewest grams of; it is the one that produces the smallest amount of product based on the mole ratio.',
    example: 'If you have 4 burger patties and 10 buns, the patties are the limiting reactant. You can only make 4 burgers.',
  },

  'excess-reactant': {
    term: 'Excess Reactant',
    definition: 'The reactant that is left over after a chemical reaction stops because the limiting reactant has run out. You start with more of it than is needed to completely consume the limiting reactant.',
    example: 'If you have 4 burger patties and 10 buns, you make 4 burgers and have 6 buns left over. Buns are the excess reactant.',
  },

  'bca-table': {
    term: 'BCA Table (Before-Change-After Table)',
    definition: 'An accounting tool used to track the quantities of all reactants and products in a chemical reaction in moles. You list the starting moles (Before), use the coefficients to calculate the change in moles (Change), and determine the final moles remaining (After). Every value in the Change row must obey the mole ratio set by the balanced equation.',
  },

  'mole-ratio': {
    term: 'Mole Ratio',
    definition: 'The ratio of the coefficients of any two substances in a balanced chemical equation. It acts as the bridge for converting moles of one substance into moles of another. If the equation says 2 H₂ + O₂ → 2 H₂O, the mole ratio between H₂ and H₂O is 2:2 (or 1:1), and between O₂ and H₂ is 1:2.',
    example: '2 mol H₂ / 1 mol O₂',
  },

  'theoretical-yield': {
    term: 'Theoretical Yield',
    definition: 'The maximum amount of product that could possibly form in a chemical reaction, calculated assuming the reaction goes perfectly and all of the limiting reactant is converted to product. It is a calculated prediction, not a lab measurement.',
  },

  'percent-yield': {
    term: 'Percent Yield',
    definition: 'A measure of a reaction\'s efficiency, calculated as (Actual Yield / Theoretical Yield) × 100%. The actual yield is the mass of product you actually weigh on a scale in the lab; the theoretical yield is what you calculated. It is almost always less than 100% due to spills, incomplete reactions, or side reactions.',
  },
