...
```bash
# from the repo root
python3 -m http.server 8000          # then open http://localhost:8000/scaffold/
...
## `References/`
`References/` holds the Unit 1 & Unit 2 review sheets (the **content source of truth**) plus the five convention posters (Four Types of Models, Energy Bar Diagrams, Modeling Chemical Reactions, Particle Diagram Poster, Showing Phase Motion).
