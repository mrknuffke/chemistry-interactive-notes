document.addEventListener("DOMContentLoaded", () => {
  ...
  const atomicMasses = {
    ...
    "He": { name: "Helium", mass: 4.00, color: "#D1F2EB", radius: 6.0 },
    "Li": { name: "Lithium", mass: 6.94, color: "#E8DAEF", radius: 7.0 },
    "Be": { name: "Beryllium", mass: 9.01, color: "#D4EFDF", radius: 7.2 },
    "B": { name: "Boron", mass: 10.81, color: "#FADBD8", radius: 7.5 },
    "C": { name: "Carbon", mass: 12.01, color: "var(--ink-mute)", radius: 8.5 },
    "N": { name: "Nitrogen", mass: 14.01, color: "#3498DB", radius: 8.0 },
    "O": { name: "Oxygen", mass: 16.00, color: "var(--accent)", radius: 7.8 },
    "F": { name: "Fluorine", mass: 19.00, color: "#1ABC9C", radius: 7.6 },
    "Ne": { name: "Neon", mass: 20.18, color: "#A9DFBF", radius: 7.8 },
    "Na": { name: "Sodium", mass: 22.99, color: "#8E44AD", radius: 9.2 },
    "Mg": { name: "Magnesium", mass: 24.31, color: "#1F618D", radius: 9.5 },
    "Al": { name: "Aluminum", mass: 26.98, color: "#B2BABB", radius: 9.0 },
    "Si": { name: "Silicon", mass: 28.09, color: "#D35400", radius: 8.8 },
    "P": { name: "Phosphorus", mass: 30.97, color: "#E67E22", radius: 8.5 },
    "S": { name: "Sulfur", mass: 32.06, color: "#F1C40F", radius: 9.2 },
    "Cl": { name: "Chlorine", mass: 35.45, color: "var(--good)", radius: 10.5 },
    "Ar": { name: "Argon", mass: 39.95, color: "#5D6D7E", radius: 9.5 },
    "K": { name: "Potassium", mass: 39.10, color: "#7D3C98", radius: 11.0 },
    "Ca": { name: "Calcium", mass: 40.08, color: "#2E4053", radius: 11.5 },
    "Sc": { name: "Scandium", mass: 44.96, color: "#A6A6A6", radius: 10.5 },
    "Ti": { name: "Titanium", mass: 47.87, color: "#BFC1C2", radius: 10.3 },
    "V": { name: "Vanadium", mass: 50.94, color: "#93B0B0", radius: 10.2 },
    "Cr": { name: "Chromium", mass: 52.00, color: "#8A99C7", radius: 10.0 },
    "Mn": { name: "Manganese", mass: 54.94, color: "#9C7AC7", radius: 10.0 },
    "Fe": { name: "Iron", mass: 55.85, color: "#BA4A00", radius: 10.0 },
    "Co": { name: "Cobalt", mass: 58.93, color: "#3A5FCD", radius: 10.0 },
    "Ni": { name: "Nickel", mass: 58.69, color: "#50C878", radius: 10.0 },
    "Cu": { name: "Copper", mass: 63.55, color: "#D35400", radius: 10.2 },
    "Zn": { name: "Zinc", mass: 65.38, color: "#7FB3D5", radius: 10.0 },
    "Ga": { name: "Gallium", mass: 69.72, color: "#C8B4D8", radius: 9.5 },
    "Ge": { name: "Germanium", mass: 72.63, color: "#7B9E89", radius: 9.3 },
    "As": { name: "Arsenic", mass: 74.92, color: "#C68642", radius: 9.2 },
    "Se": { name: "Selenium", mass: 78.97, color: "#B22222", radius: 9.2 },
    "Br": { name: "Bromine", mass: 79.90, color: "#9E4636", radius: 11.2 },
    "Kr": { name: "Krypton", mass: 83.80, color: "#566573", radius: 10.8 }
  };
